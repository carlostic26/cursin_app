...
class _HomeCategoriasSelectCardsState extends State<HomeCategoriasSelectCards> {
  ...
  Future<void> loadCountCourses() async {
    final resultConstruccion =
        await searchCountCoursesByCategory("Construccion");
    setState(() {
      categoryCounts['Construccion'] = resultConstruccion;
    });
  ...
  final Map<String, String> categoryIcons = {
    'iconConstruccion':
        'https://blogger.googleusercontent.com/img/a/AVvXsEgAAIQEt5TSo2EO_GVV8K9mIPQOfCLPhjhmCPZaFx-HxT4Ku0BQhz0kKcuJinUZ6ATsXOUcourp8DBYRTIHHFjwINGlQcE7vpkndfSqTfjGh0XaVwG1jxtqbzVPJ0de6XV4PY0Z2o3P9Q1ny_RP-NS7_dqcW2tP1B7wYb69kJdlU9KQEx4VAi_lm8bO',
    'iconTIC':
  ...
  Widget _listViewCategoryWidget() {
    return ListView(
      children: [
        ...
        buildCategoryWidget(
          title: 'CONSTRUCCIÓN',
          imageUrl: categoryIcons['iconConstruccion'],
          count: '${categoryCounts['Construccion']}',
          description:
              'Cursos gratis sobre albañilería, construcción, herramientas, seguridad y más ...',
